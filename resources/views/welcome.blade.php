...
<head>
    ...
    <title>Plagairism Checker</title>
            ...
            <div class="hidden px-6 py-4 sm:block">
                ...
                <div class="card-body">
                    <div class="imgcontainer" style="text-align: center;  margin: 24px 0 12px 0;">
                        <img src="{{ url('images/pic.png') }}" alt="Avatar" class="avatar" width="200px" height="200px">
                    </div>

                    <div class="login-register flex" style="justify-content: space-between">
                        <div class="login">
                        ...
                        <div class="register">
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="ml-4  text-gray-700 dark:text-gray-500 underline" style="  background-color: #212c73;
                                    color: white;
                                    padding: 14px 20px;
                                    margin: 8px 0;
                                    border: none;
